#
#  Be sure to run `pod spec lint DennyNavigationBar.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "DennyNavigationBar"
  spec.version      = "0.0.1"
  spec.summary      = "A library that makes it easy to set up various properties for the Navigation Bar."
  ...
  spec.source       = { :git => "https://github.com/della-padula/DennyNavigationBar.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "DennyNavigationBar", "DennyNavigationBar/**/*.{h,m,swift}"
